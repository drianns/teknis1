// =====================================================
// Template Response Page Module
// Extracted from: pages/setup-channel-email/template-response/index.blade.php
// Reads config from: #template-response-config data-* attrs
// =====================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.loadTable = function(page = 1) {
        const config = document.getElementById('template-response-config');
        if (!config) return;
        ...
        .catch(err => {
            console.error(err);
            if (tableBody) tableBody.innerHTML = '<tr><td colspan="6" class="px-4 py-12 text-center text-red-400 font-bold italic">Error loading data. Please try again.</td></tr>';
        });
    };
