// =====================================================
// Jam Operasional Page Module
// Extracted from: pages/setup-channel-email/jam-operasional/index.blade.php
// Reads config from: #jam-operasional-config data-* attrs
// =====================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.loadTable = function(page = 1) {
        const config = document.getElementById('jam-operasional-config');
        if (!config) return;
