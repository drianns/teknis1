// =====================================================
// Template Auto Reply Page Module
// Extracted from: pages/setup-channel-email/template-auto-reply/index.blade.php
// Reads config from: #template-auto-reply-config data-* attrs
// =====================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.loadTable = function(page = 1) {
        const config = document.getElementById('template-auto-reply-config');
        if (!config) return;
        ...
        .catch(err => {
            console.error(err);
            if (tableBody) tableBody.innerHTML = '<tr><td colspan="5" class="px-4 py-12 text-center text-red-400 font-bold italic">Error loading data. Please try again.</td></tr>';
        });
    };
