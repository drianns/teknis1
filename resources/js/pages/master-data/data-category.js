            ...
            <tr class="hover:bg-blue-500/[0.03] transition-colors">
                ...
                <td class="px-6 py-4 text-center">
                    <div class="flex justify-center gap-2">
                        <button onclick="openEditModal(${item.id}, ${item.data_brand_name_id || 'null'}, ${item.data_type_id || 'null'}, '${window.CrudTable.escJs(item.name)}', '${window.CrudTable.escJs(item.status)}')" class="w-8 h-8 rounded-lg bg-blue-500/10 hover:bg-blue-500/20 flex items-center justify-center text-blue-400 border border-blue-500/20"><i class='bx bx-edit-alt'></i></button>
...
window.openEditModal = function(id, brand_id, type_id, name, status) {
