...
window.openCreateModal = function() {
    document.getElementById('modalTitle').innerText = 'Add Department Escalation Unit';
...
window.openEditModal = function(id, name, status) {
    document.getElementById('modalTitle').innerText = 'Edit Department Escalation Unit';
