...
@section('content')
    <div class="flex-1 flex flex-col h-screen overflow-hidden bg-gray-900">
        <header class="flex-shrink-0 mb-3 px-6 pt-4">
            <h1 class="text-[28px] font-bold text-white tracking-tight mb-2">Filter Jumlah Hari</h1>
            <div class="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span class="mx-2">/</span>
                <span class="current text-blue-500 font-semibold">Filter Jumlah Hari</span>
            </div>
        </header>
        ...
        <div class="flex-1 flex flex-col p-4 lg:p-6 lg:pt-0 pt-0 overflow-hidden w-full">
            <div class="table-section bg-gray-800/80 backdrop-blur-md rounded-2xl border border-gray-700/50 shadow-2xl overflow-hidden ring-1 ring-white/5 flex-1 flex flex-col min-h-0">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead class="bg-gray-900/50">
                            <tr>
                                ...
                                <th class="sticky top-0 z-10 bg-gray-900 px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Nilai Hari</th>
                                <th class="sticky top-0 z-10 bg-gray-900 px-4 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Keterangan</th>
                        ...
                        <tbody class="divide-y divide-gray-700/50 text-sm text-gray-300">
                            @foreach([['id'=>1,'hari'=>7,'ket'=>'Satu Minggu'],['id'=>2,'hari'=>14,'ket'=>'Dua Minggu'],['id'=>3,'hari'=>30,'ket'=>'Satu Bulan']] as $row)
                            <tr class="hover:bg-blue-500/[0.03] transition-colors group/row">
                                ...
                                <td class="px-4 py-3 font-medium text-white">{{ $row['hari'] }} Hari</td>
                                <td class="px-4 py-3 text-gray-300">{{ $row['ket'] }}</td>
                ...
                <div class="table-pagination px-6 py-4 border-t border-gray-700/50 flex flex-wrap justify-between items-center gap-4 bg-gray-800/30">
                    <div class="text-sm text-gray-500">Showing <span class="text-white font-bold">1</span> to <span class="text-white font-bold">3</span> of <span class="text-white font-bold">3</span> entries</div>
