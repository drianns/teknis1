                    ...
                    <thead class="bg-gray-900/50 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                        <tr>
                            ...
                            <th draggable="true" @dragstart="handleDragStart($event,'Merged')" @dragend="handleDragEnd($event)"
                                class="sticky top-0 z-10 bg-gray-900 draggable-header px-3 py-3 w-24 hover:bg-gray-800/80 transition-colors group cursor-grab active:cursor-grabbing border-r border-gray-700/40 whitespace-nowrap">
...
<script>
    ...
    function interactionTableData() {
        return {
            handleDragStart(event, col) {
    ...
    function exportReport(format) {
        ...
        window.location.href = '{{ route("report.interaction-ticket") }}?' + params.toString();
    }
</script>
@endsection
