                    ...
                    <thead class="bg-gray-900/50 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                        <tr>
                            ...
                            <th draggable="true" @dragstart="handleDragStart($event,'Escalated')" @dragend="handleDragEnd($event)"
                                class="sticky top-0 z-10 bg-gray-900 draggable-header px-3 py-3 w-28 hover:bg-gray-800/80 transition-colors group cursor-grab active:cursor-grabbing whitespace-nowrap">
...
<script>
    ...
    function exportReport(format) {
        ...
        window.location.href = '{{ route("report.base-on-staff") }}?' + params.toString();
    }
</script>
@endsection
