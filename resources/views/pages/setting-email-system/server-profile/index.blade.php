                ...
                <div class="table-wrapper flex-1 overflow-auto w-full custom-scrollbar">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-700/50 text-sm text-gray-300">
                            @foreach([
                                ['id'=>1,'name'=>'BRI Life Omni Channel Development','ip'=>'10.10.10.132','db'=>'BRILife_OmniChannel','user'=>'sa','pass'=>'Sa212'],
                                ['id'=>2,'name'=>'BRI Life Omni Channel Production','ip'=>'10.10.10.132','db'=>'BRILife_OmniChannel','user'=>'sa','pass'=>'Sa212'],
                            ] as $row)
                            <tr class="hover:bg-blue-500/[0.03] transition-colors group/row">
                                ...
                                <td class="px-4 py-3 text-gray-300 whitespace-nowrap">{{ $row['ip'] }}</td>
                                <td class="px-4 py-3 text-gray-300 whitespace-nowrap">{{ $row['db'] }}</td>
                                <td class="px-4 py-3 text-gray-300 whitespace-nowrap">{{ $row['user'] }}</td>
