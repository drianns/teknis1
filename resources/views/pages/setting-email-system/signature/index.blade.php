                ...
                <div class="table-wrapper flex-1 overflow-auto w-full custom-scrollbar">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-700/50 text-sm text-gray-300">
                            @foreach([
                                ['id'=>1,'name'=>'Nespresso Indonesia','email'=>'club.indonesia@nespresso.co.id','phone'=>'+6221-12345678','body'=>'Best Regards, Nespresso Indonesia Customer Service'],
                                ['id'=>2,'name'=>'Kanmo Group','email'=>'support@kanmogroup.com','phone'=>'+6221-87654321','body'=>'Best Regards, Kanmo Group Customer Support'],
                            ] as $row)
                            <tr class="hover:bg-blue-500/[0.03] transition-colors group/row">
                                ...
                                <td class="px-4 py-3 text-gray-400 whitespace-nowrap">{{ $row['email'] }}</td>
                                <td class="px-4 py-3 text-gray-300 whitespace-nowrap">{{ $row['phone'] }}</td>
