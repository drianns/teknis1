        ...
        <main class="flex-1 p-2 md:p-4">
            ...
            <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                            ...
                            @forelse($histories as $history)
                                                        <tr class="hover:bg-gray-800/50 transition-colors even:bg-gray-900/40">
                                                            <td class="px-3 py-3 text-cyan-400 max-w-[140px]">
                                                                <div class="truncate" title="{{ $history->ticket_number }}">
                                                                    {{ $history->ticket_number }}
                                                                </div>
                                                            </td>
                                                            <td class="px-3 py-3 text-white font-medium max-w-[120px]">
                                                                <div class="truncate" title="{{ $history->name }}">{{ $history->name }}</div>
                                                            </td>
                                                            <td class="px-3 py-3 max-w-[100px]">
                                                                <div class="truncate" title="{{ $history->category }}">{{ $history->category }}
                                                                </div>
                                                            </td>
                                                            <td class="px-3 py-3 max-w-[100px]">
                                                                <div class="truncate" title="{{ $history->agent }}">{{ $history->agent }}</div>
                                                            </td>
                                                            <td class="px-3 py-3 max-w-[100px]">
                                                                <div class="truncate" title="{{ $history->posisi }}">{{ $history->posisi }}</div>
                                                            </td>
                                                            <td class="px-3 py-3 whitespace-nowrap">{{ $history->sla }}</td>
                                                            ...
                                                            <td class="px-3 py-3 text-gray-500 text-xs whitespace-nowrap">{{ $history->date }}</td>
                                                                ...
                                                                <div class="flex items-center justify-center gap-2" x-data="{ open: false }">
                                                                    <div class="relative">
                                                                        ...
                                                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                                                            ...
                                                                            style="display: none;">
                                                                            <button
                                                                                @click="orderModalOpen = true; currentTicket = '{{ $history->ticket_number }}'; open = false"
                                    ...
                                    'ticket_number' => $history->ticket_number,
                                    'name' => $history->name,
                                    'category' => $history->category,
                                    'agent' => $history->agent,
                                    'posisi' => $history->posisi,
                ...
                <div
                    ...
                    <span>Showing {{ $histories->firstItem() ?? 0 }} to {{ $histories->lastItem() ?? 0 }} of {{ $histories->total() }} entries</span>
