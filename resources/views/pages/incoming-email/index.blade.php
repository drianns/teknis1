                ...
                <div class="table-wrapper flex-1 overflow-auto w-full custom-scrollbar">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-700/50 text-sm text-gray-300">
                            @foreach([
                                ['id'=>1,'nama'=>'Budi Santoso','email'=>'budi@example.com','subject'=>'Pertanyaan Produk','tgl'=>'2025-03-01','status'=>'Masuk'],
                                ['id'=>2,'nama'=>'Siti Rahma','email'=>'siti@example.com','subject'=>'Keluhan Layanan','tgl'=>'2025-03-01','status'=>'Masuk'],
                            ] as $row)
                            <tr class="hover:bg-blue-500/[0.03] transition-colors group/row">
                                ...
                                <td class="px-4 py-3 text-gray-400">{{ $row['tgl'] }}</td>
                                <td class="px-4 py-3 text-center"><span class="bg-blue-500/20 text-blue-400 px-3 py-1 rounded-full text-xs font-semibold border border-blue-500/30 whitespace-nowrap">{{ $row['status'] }}</span></td>
