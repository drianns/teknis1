...
@section('content')
    ...
    <div id="incoming-email-config" class="hidden"
        data-endpoint="{{ route('setup-channel-email.incoming-email.getData') }}"
    ></div>
@push('scripts')
    @vite('resources/js/pages/setup-channel-email/incoming-email.js')
@endpush
@endsection
