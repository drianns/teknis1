                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-700/50 text-sm text-gray-300">
                            ...
                            <tr class="hover:bg-blue-500/[0.03] transition-colors">
                                ...
                                <td class="px-4 py-3 text-gray-400 truncate max-w-sm">{{ $row['body'] }}</td>
                                <td class="px-4 py-3 text-gray-300">{{ $row['kategori'] ?? 'General' }}</td>
                            ...
                            <tr>
                                <td colspan="6" class="px-4 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center gap-2 text-gray-500">
                                        ...
                                        <p class="text-sm font-medium">No response templates found</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
