...
@section('content')
    ...
    <div id="template-response-config" class="hidden"
        data-endpoint="{{ route('setup-channel-email.template-response.getData') }}"
    ></div>
@push('scripts')
    @vite('resources/js/pages/setup-channel-email/template-response.js')
@endpush
@endsection
