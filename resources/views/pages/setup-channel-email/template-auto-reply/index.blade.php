...
@section('content')
    ...
    <div id="template-auto-reply-config" class="hidden"
        data-endpoint="{{ route('setup-channel-email.template-auto-reply.getData') }}"
    ></div>
@push('scripts')
    @vite('resources/js/pages/setup-channel-email/template-auto-reply.js')
@endpush
@endsection
