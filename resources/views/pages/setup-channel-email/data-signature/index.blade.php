                ...
                <div class="table-wrapper flex-1 overflow-auto w-full custom-scrollbar">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-700/50 text-sm text-gray-300">
                            @foreach([
                                ['id'=>1,'nama'=>'Signature Kanmo Group','konten'=>'Best Regards, Kanmo Group | support@kanmogroup.com'],
                                ['id'=>2,'nama'=>'Signature Nespresso','konten'=>'Best Regards, Nespresso Indonesia | club.indonesia@nespresso.co.id'],
                            ] as $row)
                            <tr class="hover:bg-blue-500/[0.03] transition-colors group/row">
                                ...
                                <td class="px-4 py-3 text-gray-400 truncate max-w-md">{{ $row['konten'] }}</td>
