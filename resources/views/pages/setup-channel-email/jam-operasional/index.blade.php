...
@section('content')
    ...
    <div id="jam-operasional-config" class="hidden"
        data-endpoint="{{ route('setup-channel-email.jam-operasional.getData') }}"
    ></div>
@push('scripts')
    @vite('resources/js/pages/setup-channel-email/jam-operasional.js')
@endpush
@endsection
