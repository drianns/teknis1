...
@section('content')
    <div class="flex-1 flex flex-col h-screen overflow-hidden bg-gray-900">
        <header class="flex-shrink-0 mb-3 px-6 pt-4">
            <div class="flex justify-between items-center mb-2">
                <h1 class="text-[28px] font-bold text-white tracking-tight">Data Fulfillment Location</h1>
            ...
            <div class="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span class="text-blue-500 font-semibold">Data Fulfillment Location</span>
            </div>
        </header>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-12">
            ...
            <div class="relative bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden border border-gray-700 ring-1 ring-white/5">
                <div class="px-6 py-4 border-b border-gray-700 flex justify-between items-center bg-gray-900/50">
                    <h3 id="modalTitle" class="text-xl font-bold text-white">Add New Fulfillment Location</h3>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-gray-400">Location Name</label>
    ...
    <script>
        const AJAX_URL='{{ url("data-fulfillment-location/data") }}',STORE_URL='{{ route("data-fulfillment-location.store") }}',UPDATE_BASE='{{ url("data-fulfillment-location") }}',DELETE_BASE='{{ url("data-fulfillment-location") }}',CSRF='{{ csrf_token() }}';
