...
@section('content')
    ...
    <div id="data-access-config" class="hidden" data-get="{{ route('management-user.data-access-application.getData') }}" data-store="{{ route('management-user.data-access-application.store') }}"></div>
    @push('scripts')
        @vite('resources/js/pages/management-user/data-access-application.js')
    @endpush
@endsection